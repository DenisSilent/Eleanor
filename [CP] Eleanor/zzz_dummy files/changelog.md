...
- Commented out the mails as there is only a debug mail
- Secret mail not working Discord help by:
  - `fate4886`
  - `tiakall`
  - `selphers`
- Checked:
  - secrets (zzz_secrets.json)
  - mails (mails.json)
...
- Final checking before mod release! 🎉
- Checked:
  - schedules (not really and not all of them, but...) (schedules.json)
  - NPC raphics (NPCgraphics.json)
...
- unified _"NexusMods page.md"_ and _"README.md"_ formating
- unified _Dynamic Tokens_ formating
